...
- [ ] **Phase 20: Fix Notification Dropdown Mobile** - Fix notification dropdown positioning on mobile view
- [ ] **Phase 21: Notifications Page Mobile UX** - Improve notifications page UI/UX for mobile view
- [ ] **Phase 22: Team Browse Scroll Container** - Compact team search list with scroll container in teams/onboarding pages
- [ ] **Phase 23: Team Settings Reorder Members** - Move team members section below deletion section in team settings page
...
### Phase 20: Fix Notification Dropdown Mobile
**Goal**: Fix notification dropdown positioning on mobile view — currently renders outside the visible viewport
**Depends on**: None (standalone bug fix)
**Requirements**: UI-BUG
**Success Criteria** (what must be TRUE):
  1. Notification dropdown is fully visible and usable on mobile screen sizes
  2. Dropdown content does not overflow outside the viewport on any mobile breakpoint
**Plans**: TBD

Plans:
- [ ] 20-01-PLAN.md — TBD

### Phase 21: Notifications Page Mobile UX
**Goal**: Improve the /notifications page UI/UX for mobile view — currently layout is broken and unusable on small screens
**Depends on**: None (standalone UX improvement)
**Requirements**: UI-UX
**Success Criteria** (what must be TRUE):
  1. Notifications page is fully readable and usable on mobile screen sizes
  2. Notification items have proper spacing, text wrapping, and touch-friendly targets
  3. Action buttons (accept/decline invitations) are accessible without horizontal scrolling
**Plans**: TBD

Plans:
- [ ] 21-01-PLAN.md — TBD

### Phase 22: Team Browse Scroll Container
**Goal**: Wrap team browse/search list in a compact scrollable container so it doesn't take over the full page height in /teams and onboarding pages
**Depends on**: None (standalone UX improvement)
**Requirements**: UI-UX
**Success Criteria** (what must be TRUE):
  1. Team browse list has a fixed max-height with vertical scrolling in both /teams page and onboarding wizard
  2. Search input stays visible above the scrollable list (not scrolled away)
  3. List is usable on both mobile and desktop without excessive vertical space usage
**Plans**: TBD

Plans:
- [ ] 22-01-PLAN.md — TBD

### Phase 23: Team Settings Reorder Members
**Goal**: Move the team members section below the deletion section in the Team/{id} settings page
**Depends on**: None (standalone layout change)
**Requirements**: UI-UX
**Success Criteria** (what must be TRUE):
  1. Team members section appears below the delete team section on the team settings page
**Plans**: TBD
